module.exports = (function() {
  ...
  function parse(input) {
     ...
     */
    var build, depths, indent, isArray, lvl, prev;
    ...
    build = function(list) {
      var doIndent, doc, item, key, keyStack, keys, len, name, newObj, newObjIdx, obj, prevObj, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _newObj, _ref, _ref1, _ref2;
      keyStack = [];
        ...
        switch (item.type) {
          case 'tag':
            ...
            if (obj[key] == null) {
              ...
              if (((item.value == null) || (typeof item.value === 'string')) && !isArray(obj[key])) {
                obj[key] = [obj[key]];
              }
              if (isArray(obj[key])) {
                if (item.value != null) {
