module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c20 = function(tag) {
            prev = tag
            return tag;
          },
        peg$c21 = /^[^\n]/,
        peg$c22 = { type: "class", value: "[^\\n]", description: "[^\\n]" },
        peg$c23 = function(str) {
     ...
     */
    var build, depths, indent, isArray, isPrimitive, lvl, prev, primitiveTypes,
    ...
    build = function(list) {
      var doIndent, doc, item, key, keyStack, keys, len, name, newObj, obj, prevObj, value, _i, _j, _k, _l, _len, _len1, _len2, _len3, _len4, _m, _newObj, _obj, _ref, _ref1, _ref2, _ref3, _ref4;
      keyStack = [];
        ...
        switch (item.type) {
          ...
          case 'text':
            ...
            if (newObj['!text'] != null) {
              ...
              if ((_ref4 = typeof newObj) === 'string' || _ref4 === 'boolean' || _ref4 === 'number') {
